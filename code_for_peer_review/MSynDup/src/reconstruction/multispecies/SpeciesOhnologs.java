...
public class SpeciesOhnologs{
	...
	int totalOhnologs_;// in the focal segmentList
	long totalGenePairs_;// in the focal segmentList
	long totalGeneSize_;// in the focal segmentList
	...
	static public void addSpeciesSegmentAndOhnologs(String species, OhnologDistributionTable odt, ConservedBlockList cbl){
