...
public class SingleLinkageClustering{
	...
	public void computeClusters(double threshold){
		...
		for(Edge e: edgeList_){
			...
			if(clusterIndex1==clusterIndex2) continue;// already merged.
			if(isValidMerge(clusterIndex1, clusterIndex2)==false) continue;
	...
	class Edge implements Comparable<Edge>{
		...
		public int compareTo(Edge arg0){
			if(dist_==arg0.dist_) return 0;
			if(dist_>arg0.dist_) return 1;
			return -1;
		}
